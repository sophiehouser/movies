...
def exit_option(db: MovieDatabase):
    """
...
def list_movies_option(db: MovieDatabase):
    """
    Lists all movies
    :param db: MovieDatabase
    """
...
def add_movie_option(db: MovieDatabase, title=""):
    """
...
def delete_movie_option(db: MovieDatabase):
    """
...
def update_movie_option(db: MovieDatabase):
    """
...
def stats_option(db: MovieDatabase):
    """
...
def random_movie_option(db: MovieDatabase):
    """
...
def search_movie_option(db: MovieDatabase):
    """
...
def sorted_by_rating_option(db: MovieDatabase):
    """
...
def manage_user_input(user_input, db: MovieDatabase):
    """
